...
<html>
  ...
  <script src="https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="index1.html" id="A">কৃষি তথ্য ও প্রযুক্তি </a></h1>
    </div>
...
$res=mysqli_query($db,"SELECT * FROM crops NATURAL JOIN crops_image WHERE catagory_name='ফুল'");
