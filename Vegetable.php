  ...
  <div class="row">
    ...
    <div class="jumbotron">
      ...
      <div >
        ...
        <img src="img/multiveg.png" class="img-responsive" >
      </div>
...
$res=mysqli_query($db,"SELECT * FROM crops NATURAL JOIN crops_image WHERE catagory_name='শাকসবজি'");
   ...
   $crop_name=$row['crops_name'];
     echo "
      <div class=\"row\">
        ...
        <div class=\"col-sm-9\">
          <div class=\"well\">
         <h6> <a href=\"detail_info.php?ach=$crop_name\">".$crop_name."</a></h6>
               <p>
