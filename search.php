  ...
  <div class="row">
    ...
    <div class="jumbotron">
      ...
      <div >
        ...
        <img src="img/tomatto.jpg" class="img-responsive" >
      </div>
...
$search=$_POST['search'];
echo $search;
$res=mysqli_query($db,"select * from crops where crops.crops_name = '".$search."' ");
$res1=mysqli_query($db,"select DISTINCT(disease.disease_name),disease.disease_sol,disease_description from disease,mayhave where disease.crops_name = '".$search."' ");
